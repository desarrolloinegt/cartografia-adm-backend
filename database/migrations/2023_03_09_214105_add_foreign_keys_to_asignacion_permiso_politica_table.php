...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('asignacion_permiso_politica', function (Blueprint $table) {
            $table->foreign(['permiso_id'], 'fk_Asignacion Permisos_Permiso1')->references(['id'])->on('permiso')->onUpdate('NO ACTION')->onDelete('NO ACTION');
            $table->foreign(['politica_id'], 'fk_Asignacion Permisos_Rol1')->references(['id'])->on('politica')->onUpdate('NO ACTION')->onDelete('NO ACTION');
        });
    }
